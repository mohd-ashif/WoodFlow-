...
Refer to [DATABASE_MIGRATION_GUIDE.md](DATABASE_MIGRATION_GUIDE.md) Section 5. Apply counter-migration DDL scripts without dropping production data tables.
